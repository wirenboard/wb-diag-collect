...
class AsyncMQTTRPCServer:
    ...
    def _on_connect(self, _client, _userdata, _flags, rc, *_):
        ...
        # the session is not persistent, so a reconnect loses the subscriptions: the guideline requires
        # re-subscribing and republishing the RPC endpoints in the connect handler
